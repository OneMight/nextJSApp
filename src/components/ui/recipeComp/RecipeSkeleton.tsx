...
export const RecipeSkeleton = () => {
  return (
    <article className="w-67.5 h-89.5 shrink-0 relative bg-white-fg rounded-2xl overflow-hidden">
      <Skeleton className="w-full h-67.5 rounded-t-2xl rounded-b-none bg-slate-200/80" />
